...
--remove publisher from event class, only planner exists and they are not necessarily the one
--that uploads the event
-- @block Event
...
-- @block Jobs
CREATE OR REPLACE TABLE JobOffers(
    
);

CREATE OR REPLACE TABLE JobApplications(
